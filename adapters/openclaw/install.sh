#!/usr/bin/env bash
# ============================================================
# Hermes-Nexus OpenClaw Adapter — One-Click Installer
# ============================================================
# Installs the Memoria Engine into an OpenClaw environment.
#
# Modes:
...
banner() {
    echo ""
    echo -e "${BLUE}${BOLD}╔══════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}${BOLD}║   Hermes-Nexus OpenClaw Adapter — Installer             ║${NC}"
...
# Generated by OpenClaw Adapter installer
...
# ────────── Step 4: Skill Registration Hint (OpenClaw) ──────────
info "OpenClaw Skill file location:"
SKILL_MD="$SCRIPT_DIR/SKILL.md"
if [ -f "$SKILL_MD" ]; then
    success "SKILL.md found at $SKILL_MD"
    echo ""
    echo -e "  ${YELLOW}To register in OpenClaw:${NC}"
    echo -e "  ${BOLD}mkdir -p ~/.openclaw/skills/memoria-engine${NC}"
    echo -e "  ${BOLD}cp $SKILL_MD ~/.openclaw/skills/memoria-engine/SKILL.md${NC}"
    echo "  Then restart OpenClaw or reload skills."
else
...
echo -e "  ${BOLD}Platform:${NC}    openclaw"
...
echo ""
echo -e "  ${BOLD}Next:${NC} Register the skill in OpenClaw to activate memory tracking."
echo ""
